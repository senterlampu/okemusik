...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'dashstore' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'dashstore' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'dashstore' ),
		'repeat'    => esc_html__( 'Repeat All', 'dashstore' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'dashstore' ),
		'top center'    => esc_html__( 'Top Center', 'dashstore' ),
		'top right'     => esc_html__( 'Top Right', 'dashstore' ),
		'center left'   => esc_html__( 'Middle Left', 'dashstore' ),
		'center center' => esc_html__( 'Middle Center', 'dashstore' ),
		'center right'  => esc_html__( 'Middle Right', 'dashstore' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'dashstore' ),
		'bottom center' => esc_html__( 'Bottom Center', 'dashstore' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'dashstore')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'dashstore' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'dashstore')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'dashstore' ),
		'italic'      => esc_html__( 'Italic', 'dashstore' ),
		'bold'        => esc_html__( 'Bold', 'dashstore' ),
		'lighter'     => esc_html__( 'Light', 'dashstore' ),
		'bold italic' => esc_html__( 'Bold Italic', 'dashstore' )
		);
