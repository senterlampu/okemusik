...
jQuery(document).ready(function($) {
	...
	var orange_default = new Array();
	orange_default['primary_text_typography_color']='#646565';
	orange_default['secondary_text_color']='#898e91';
	orange_default['content_headings_typography_color']='#484747';
	orange_default['sidebar_headings_typography_color']='#151515';
	orange_default['footer_headings_typography_color']='#f8f8f6';
	orange_default['footer_text_color']='#f8f8f6';
	orange_default['link_color']='#151515';
	orange_default['link_color_hover']='#f7972b';
	orange_default['button_typography_color']='#444444';
	orange_default['button_background_color']='#f7f8f8';
	orange_default['button_text_hovered_color']='#ffffff';
	orange_default['main_decor_color']='#f7972b';
	orange_default['main_border_color']='#e7e4d9';
	...
	$('#base_color_scheme').change(function() {
	  colorscheme = $(this).val();
		if (colorscheme == 'orange_default') { colorscheme = orange_default; }
