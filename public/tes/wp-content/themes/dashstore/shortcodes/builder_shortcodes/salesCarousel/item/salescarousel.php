	...
	class IG_Item_Salescarousel extends IG_Pb_Shortcode_Child {
		...
		public function element_items() {
			$this->items = array(
				'Notab' => array(
					...
					array(
                        'name' 	  => esc_html__( "Enter Sale Product ID", 'dashstore' ),
                        'id'      => 'product_id',
						'type'    => 'text_field',
						'class'   => 'jsn-input-xxlarge-fluid',
                        'std'     => '',
					...
					array(
						'name'    => esc_html__( 'Target Date', 'dashstore' ),
						'id'      => 'target_date',
						'type'    => 'text_field',
						'class'   => 'jsn-input-xxlarge-fluid',
						'std'     => '2015-12-26',
						'tooltip' => esc_html__( 'Set target date (YYYY-MM-DD) when special offer ends', 'dashstore' )
					),
					array(
						'name'    => esc_html__( 'Pre-Countdown text', 'dashstore' ),
		...
		public function element_shortcode_full( $atts = null, $content = null ) {
			...
			if ( isset( $product_id ) ) {
				...
				$html_output .= '<h4>'.esc_html__('Sale!', 'dashstore').'</h4>';
