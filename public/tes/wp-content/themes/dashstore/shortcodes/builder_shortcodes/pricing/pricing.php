...
if ( ! class_exists( 'IG_Pricing' ) ) {
	...
	class IG_Pricing extends IG_Pb_Shortcode_Parent {
		...
		public function element_config() {
			...
			$this->config['shortcode'] = strtolower( __CLASS__ );
			$this->config['name']      = esc_html__( 'PT Pricing Table', 'dashstore' );
			$this->config['has_subshortcode'] = 'IG_Item_' . str_replace( 'IG_', '', __CLASS__ );
			$this->config['exception'] = array(
				'default_content'  => esc_html__( 'PT Pricing Table', 'dashstore' ),
				'data-modal-title' => esc_html__( 'PT Pricing Table', 'dashstore' )
			);
		...
		public function element_items() {
			$this->items = array(
				'content' => array(
					...
					array(
						'id'      => 'pb_title',
						'name'    => esc_html__( 'Pricing Title', 'dashstore' ),
						'type'    => 'text_field',
						'class'   => 'jsn-input-xxlarge-fluid',
						'std'     => '',
						'tooltip' => esc_html__( 'Set the title', 'dashstore' )
					),
					array(
						'id'      => 'pb_info',
						'name'    => esc_html__( 'Pricing Info', 'dashstore' ),
						'type'    => 'text_field',
						'class'   => 'jsn-input-medium-fluid',
						'std'     => '',
						'tooltip' => esc_html__( 'Set the pricing table info(short description)', 'dashstore' )
					),
					array(
						'id'      => 'pb_price',
						'name'    => esc_html__( 'Price', 'dashstore' ),
						'type'    => 'text_field',
						'class'   => 'jsn-input-small-fluid',
						'std'     => '',
						'tooltip' => esc_html__( 'Set the price', 'dashstore' )
					),
					array(
						'id'      => 'pb_currency',
						'name'    => esc_html__( 'Currency Sign', 'dashstore' ),
						'type'    => 'text_field',
						'class'   => 'jsn-input-small-fluid',
						'std'     => '',
						'tooltip' => esc_html__( 'Set the currency sign', 'dashstore' )
					),
					array(
						'id'            => 'pricing_items',
						'type'          => 'group',
					...
					array(
						'name'    => esc_html__( 'Button Title', 'dashstore' ),
						'id'      => 'pb_button_title',
						'type'    => 'text_field',
						'class'   => 'jsn-input-xxlarge-fluid',
						'std'     => '',
						'tooltip' => esc_html__( 'Set Button Title', 'dashstore' )
					),
					array(
						...
						'class'      => 'jsn-input-xxlarge-fluid',
						'std'        => 'http://',
						'tooltip'    => esc_html__( 'URL of button link', 'dashstore' ),
					),
				),
				'styling' => array(
					array(
						'name' => esc_html__( 'Background color for Title block', 'dashstore' ),
						'type' => array(
							array(
					...
					array(
						'name' => esc_html__( 'Background color for Description/Price block', 'dashstore' ),
						'type' => array(
							array(
								'id'           => 'pb_info_bg_value',
								'type'         => 'text_field',
