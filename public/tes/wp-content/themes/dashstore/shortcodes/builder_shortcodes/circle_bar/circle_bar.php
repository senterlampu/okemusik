...
class IG_Circle_Bar extends IG_Pb_Shortcode_Parent {
	...
	public function element_config() {
		...
		$this->config['name']             = esc_html__( 'PT Circle Bar', 'dashstore' );

		// Define exception for this shortcode
		$this->config['exception'] = array(
				'default_content'  => esc_html__( 'PT Circle Bar',  'dashstore' ),
				'data-modal-title' => esc_html__( 'PT Circle Bar',  'dashstore' ),
	...
	public function element_items() {
		$this->items = array(
			'content' => array(
				...
				array(
					'name'         => esc_html__( 'Percentage', 'dashstore' ),
					'id'           => 'cbar_percentage',
					'type'         => 'text_append',
					'input_type'   => 'number',
					'class'        => 'input-mini',
					...
					'tooltip'      => esc_html__( 'Percentage', 'dashstore' )
				),
				array(
					'id'      => 'cbar_title',
					'name'    => esc_html__( 'Circle Bar Title',  'dashstore' ),
					'type'    => 'text_field',
					'class'   => 'jsn-input-xxlarge-fluid',
					'std'     => '',
			...
			'styling' => array(
				array(
					'name' => esc_html__( 'Color for Circle Bar', 'dashstore' ),
					'type' => array(
						array(
							'id'           => 'cbar_bg_value',
							'type'         => 'text_field',
				...
				array(
					'name'         => esc_html__( 'Set radius for bar',  'dashstore' ),
					'id'           => 'dimension_radius',
					'type'         => 'text_append',
					'input_type'   => 'number',
					'class'        => 'input-mini',
				...
				array(
					'name'         => esc_html__( 'Set bar width',  'dashstore' ),
					'id'           => 'bar_width',
					'type'         => 'text_append',
					'input_type'   => 'number',
					'class'        => 'input-mini',
				...
				array(
					'name'       => esc_html__( 'Show Icon', 'dashstore' ),
					'id'         => 'show_icon',
					'type'       => 'radio',
					'std'        => 'yes',
				...
				array(
					'name'      => esc_html__( 'Icon', 'dashstore' ),
					'id'        => 'icon',
					'type'      => 'icons',
					'std'       => '',
					'role'      => 'title_prepend',
					'title_prepend_type' => 'icon',
					'tooltip'   => esc_html__( 'Select an icon', 'dashstore' ),
					'dependency'=> array( 'show_icon', '=', 'yes' )
				),				
				array(
					'name' => esc_html__( 'Icon Color', 'dashstore' ),
					'type' => array(
						array(
							'id'           => 'icon_c_value',
							'type'         => 'text_field',
					...
					'tooltip'         => esc_html__( 'Set Icon Color', 'dashstore' ),
					'container_class' => 'combo-group',
					'dependency'      => array( 'show_icon', '=', 'yes' )
				),
				array(
