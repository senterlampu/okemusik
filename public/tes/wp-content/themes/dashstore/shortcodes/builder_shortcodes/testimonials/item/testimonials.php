	...
	class IG_Item_Testimonials extends IG_Pb_Shortcode_Child {
		...
		public function element_config() {
			...
			$this->config['exception'] = array(
				'data-modal-title' => esc_html__( 'Testimonials Item', 'dashstore' )
			);
		...
		public function element_items() {
			$this->items = array(
				'Notab' => array(
					...
					array(
						'name'    => esc_html__( 'Occupation', 'dashstore' ),
						'id'      => 'occupation',
						'type'    => 'text_field',
						'class'   => 'input-sm',
					),
					array(
						'name' => esc_html__( 'Text', 'dashstore' ),
						'id'   => 'body',
						'role' => 'content',
						'type' => 'editor',
						'std'  => IG_Pb_Helper_Type::lorem_text(),
                        'tooltip' => esc_html__( 'Set content of element', 'dashstore' ),
					),
					array(
