<h2><?php esc_html_e( 'Settings', 'dashstore' ); ?></h2>
...
<form method="post">
	...
	if ( $shop_description !== 'false' ) {
		...
		do_action( 'wcvendors_settings_frontend_after_shop_description' );
	}
	?>

	<?php wp_nonce_field( 'save-shop-settings', 'wc-product-vendor-nonce' ); ?>
	<input type="submit" class="btn btn-inverse btn-small" style="float:none;" name="vendor_application_submit" value="<?php esc_html_e( 'Save', 'dashstore' ); ?>"/>
</form>
