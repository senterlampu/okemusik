...
get_header( 'shop' ); ?>
	...
	<h1 class="page-title"><?php _e( 'Customer Ratings', 'dashstore' ); ?></h1>
	...
	<?php if ( $vendor_feedback ) {
		...
		foreach ( $vendor_feedback as $vf ) {
			...
			<div class="single-rating">
				<p>
					<?php _e('Product: ', 'dashstore'); ?>
					<a href="<?php echo $product_link; ?>" target="_blank"><?php echo $product_title; ?></a>
				</p>
				<p>
					<span><?php _e( 'Posted on ', 'dashstore'); echo $post_date; ?></span>
					<?php _e( ' by ', 'dashstore'); echo $customer_name; ?>
				</p>
		...
		<?php }
	} else {  echo __( 'No ratings have been submitted for this vendor yet.', 'dashstore' ); }  ?>

	<a class="button" href="<?php echo $vendor_shop_url; ?>"><?php _e( 'Return to store', 'dashstore' ); ?></a>
