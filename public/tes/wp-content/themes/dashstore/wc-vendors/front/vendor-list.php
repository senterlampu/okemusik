...
if ( $logo_src && $logo_src != '') {
	...
	$store_icon_src = wp_get_attachment_image_src( $id, 'shop_catalog' );
...
<li class="single-vendor">
	<div class="inner-vendor-content row">
		...
		<div class="additional-info col-xs-12">
			...
			<a class="btn btn-primary rounded link-to-vendor" href="<?php echo esc_url($shop_link); ?>" rel="nofollow"><?php echo esc_html__('Visit Vendor Store', 'dashstore'); ?></a>
		</div>
