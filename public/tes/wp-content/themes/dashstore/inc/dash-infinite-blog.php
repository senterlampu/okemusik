...
if ( ! function_exists( 'dash_infinite_blog' ) ) :
...
if (class_exists('Woocommerce')) {
	if (!is_singular() && !is_woocommerce()) {
		add_filter('wp_footer', 'dash_infinite_blog');
	}
} else {
	if (!is_singular()) {
		add_filter('wp_footer', 'dash_infinite_blog');
...
add_action('wp_ajax_get_more', 'dash_infinite_loop');         
add_action('wp_ajax_nopriv_get_more', 'dash_infinite_loop');
function dash_infinite_loop() {
	global $wp_query;
