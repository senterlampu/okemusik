        ...
        if( get_option('suppa_locations_skins') )
        {
            ...
            foreach ( $locations as $loc => $skin )
            {
                ...
                $thumbs[$skin] = array(
                                        ...
                                        'mega'   => array( (int)$json_data['submenu-megaposts-post_width'], (int)$json_data['submenu-megaposts-post_height'] ) ,
	...
	function save_to_files( $location_info ){
        ...
        '
             ...
             ******** SubMenu Mega Links Two
             ---------------------------------------------------------------- **/
            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_submenu .suppa_linksTwo_categoriesContainer a {
                font-size:'.$skin_data['megaLinksTwo_mainLinks_font_font_size'].'px !important;
                font-family:'.$skin_data['megaLinksTwo_mainLinks_font_font_family'].' !important;
                '.$skin_data['megaLinksTwo_mainLinks_font_font_family_style'].'

                padding-top:    '.$skin_data['megaLinksTwo_mainLinks_padding_top'].';
                padding-bottom: '.$skin_data['megaLinksTwo_mainLinks_padding_bottom'].';
                padding-left:   '.$skin_data['megaLinksTwo_mainLinks_padding_left'].';
                padding-right:  '.$skin_data['megaLinksTwo_mainLinks_padding_right'].';

                /* color/bg/border */
                color:'.$skin_data['megaLinksTwo_mainLinks_font_font_color'].';
                border-bottom:1px solid '.$skin_data['megaLinksTwo_mainLinks_borderColor'].';
            }
            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_linksTwo_categoriesContainer a:hover,
            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_linksTwo_categoriesContainer a.suppa_linksTwo_categoriesContainer_current {
                color:'.$skin_data['megaLinksTwo_mainLinks_colorHover'].';
                background-color:'.$skin_data['megaLinksTwo_mainLinks_bgColorHover'].';
            }

            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_linksTwo_cat a {
                font-size:'.$skin_data['megaLinksTwo_links_font_font_size'].'px !important;
                font-family:'.$skin_data['megaLinksTwo_links_font_font_family'].' !important;
                '.$skin_data['megaLinksTwo_links_font_font_family_style'].'

                padding-top:    '.$skin_data['megaLinksTwo_links_padding_top'].';
                padding-bottom: '.$skin_data['megaLinksTwo_links_padding_bottom'].';
                padding-left:   '.$skin_data['megaLinksTwo_links_padding_left'].';
                padding-right:  '.$skin_data['megaLinksTwo_links_padding_right'].';

                /* color/bg/border */
                color:'.$skin_data['megaLinksTwo_links_font_font_color'].';
            }
            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_submenu .suppa_linksTwo_cat a:hover {
                color:'.$skin_data['megaLinksTwo_links_color_hover'].';
            }

            /** ----------------------------------------------------------------
             ******** SubMenu Mega Links Two Arrow Style
             ---------------------------------------------------------------- **/
            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_submenu .suppa_linksTwo_categoriesContainer a .suppa_megaLinksTwo_mainLinkArrow{
                top:'.$skin_data['megaLinksTwo_mainLinks_arrow_position_top'].' !important;
                right:'.$skin_data['megaLinksTwo_mainLinks_arrow_position_right'].' !important;
            }
            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_submenu .suppa_linksTwo_categoriesContainer a .suppa_megaLinksTwo_mainLinkArrow span {
                font-size:'.$skin_data['megaLinksTwo_mainLinks_arrow_width'].' !important;
                /* color/bg/border */
                color:'.$skin_data['megaLinksTwo_mainLinks_arrow_color'].';
            }
            .'.$location_info[0].' .suppa_menu_linksTwo .suppa_submenu .suppa_linksTwo_categoriesContainer a:hover .suppa_megaLinksTwo_mainLinkArrow span,
            .suppa_linksTwo_categoriesContainer_current .suppa_megaLinksTwo_mainLinkArrow span{
                color:'.$skin_data['megaLinksTwo_mainLinks_arrow_color_hover'].' !important;
            }
             ...
             ******** SubMenu Mega Posts
             ---------------------------------------------------------------- **/
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories{
                margin-top:'. $skin_data['submenu-megaposts-post_margin_top'] .';
            }
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a {
                font-family : '. $skin_data['submenu-megaposts-cat_link_font_font_family'] .' !important;
                font-size:'.$skin_data['submenu-megaposts-cat_link_font_font_size'].'px !important;
                '. $skin_data['submenu-megaposts-cat_link_font_font_family_style'] .'
                color :'. $skin_data['submenu-megaposts-cat_link_font_font_color'] .';
                padding-top:'. $skin_data['submenu-megaposts-cat_link_padding_top'] .';
                padding-left:'. $skin_data['submenu-megaposts-cat_link_padding_left'] .';
                padding-bottom:'. $skin_data['submenu-megaposts-cat_link_padding_bottom'] .';
                padding-right:'. $skin_data['submenu-megaposts-cat_link_padding_right'] .';

                background-color:'. $skin_data['submenu-megaposts-cat_link_bg_color'] .';
            }
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a .suppa_item_title{
                font-family : '. $skin_data['submenu-megaposts-cat_link_font_font_family'] .' !important;
                font-size:'.$skin_data['submenu-megaposts-cat_link_font_font_size'].'px !important;
                '. $skin_data['submenu-megaposts-cat_link_font_font_family_style'] .'
                color :'. $skin_data['submenu-megaposts-cat_link_font_font_color'] .';
            }
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a:hover,
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a.suppa_mega_posts_cat_selected {
                background-color:'. $skin_data['submenu-megaposts-cat_link_bg_color_hover'] .';
                color :'. $skin_data['submenu-megaposts-cat_link_color_hover'] .';
            }

            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a:hover .suppa_item_title,
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a.suppa_mega_posts_cat_selected .suppa_item_title{
                color :'. $skin_data['submenu-megaposts-cat_link_color_hover'] .';
            }
            .'.$location_info[0].' .suppa_mega_posts_post_article {
                margin-top:'. $skin_data['submenu-megaposts-post_margin_top'] .';
                margin-left:'. $skin_data['submenu-megaposts-post_margin_left'] .';
                margin-bottom:'. $skin_data['submenu-megaposts-post_margin_bottom'] .';
                margin-right:'. $skin_data['submenu-megaposts-post_margin_right'] .';
            }

            .'.$location_info[0].' .suppa_mega_posts_post_article span{
                font-family : '. $skin_data['submenu-megaposts-post_link_font_font_family'] .' !important;
                font-size:'.$skin_data['submenu-megaposts-post_link_font_font_size'].'px !important;
                '. $skin_data['submenu-megaposts-post_link_font_font_family_style'] .'
                color :'. $skin_data['submenu-megaposts-post_link_font_font_color'] .';

                padding-top:'. $skin_data['submenu-megaposts-post_link_padding_top'] .';
                padding-left:'. $skin_data['submenu-megaposts-post_link_padding_left'] .';
                padding-bottom:'. $skin_data['submenu-megaposts-post_link_padding_bottom'] .';
                padding-right:'. $skin_data['submenu-megaposts-post_link_padding_right'] .';

            }

            .'.$location_info[0].' .suppa_mega_posts_post_article div.suppa_post_link_container {
                background-color: '.$skin_data['mega_posts_link_bg_color'].' !important ;
            }

            .'.$location_info[0].' .suppa_mega_posts_post_article:hover span{
                color :'. $skin_data['submenu-megaposts-post_link_color_hover'] .';
            }

            .'.$location_info[0].' .suppa_mega_posts_post_article {
                width : '. $skin_data['submenu-megaposts-post_width'] .' !important;
            }
                .'.$location_info[0].' .suppa_mega_posts_post_article img{
                    width : '. $skin_data['submenu-megaposts-post_width'] .' !important;
                    height : '. $skin_data['submenu-megaposts-post_height'] .' !important;
                }

            /** ----------------------------------------------------------------
             ******** Submenu Mega Posts Arrow Style
             ---------------------------------------------------------------- **/
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a .suppa_mega_posts_arrow {
                top:'.$skin_data['submenu-megaposts-cat_link_arrow_position_top'].' !important;
                right:'.$skin_data['submenu-megaposts-cat_link_arrow_position_right'].' !important;
            }
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a .suppa_mega_posts_arrow span {
                font-size:'.$skin_data['submenu-megaposts-cat_link_arrow_width'].' !important;
                /* color/bg/border */
                color:'.$skin_data['submenu-megaposts-cat_link_arrow_color'].';
            }
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_categories a:hover .suppa_mega_posts_arrow span {
                color:'.$skin_data['submenu-megaposts-cat_link_arrow_color_hover'].';
            }

            /** Needed for suppa_frontend.js **/
            .'.$location_info[0].' .suppa_menu_mega_posts .suppa_mega_posts_cat_selected .suppa_mega_posts_arrow span{
                color:'.$skin_data['submenu-megaposts-cat_link_arrow_color_hover'].' !important;
            }
             ...
             ******** Submenu Mega Links Style
             ---------------------------------------------------------------- **/
            .'.$location_info[0].' .suppa_column {
                margin-left:'.$skin_data['submenu_column_right_margin'].' !important;
                margin-bottom:'.$skin_data['submenu_column_right_margin'].' !important;
            }

            /* Column Title */
            .'.$location_info[0].' .suppa_column_title {
                font-size:'.$skin_data['submenu-links-title_link_font_font_size'].'px !important;
                font-family:'.$skin_data['submenu-links-title_link_font_font_family'].' !important;
                '.$skin_data['submenu-links-title_link_font_font_family_style'].'
                color:'.$skin_data['submenu-links-title_link_font_font_color'].';
                border-bottom-color:'.$skin_data['submenu-links-title_bottom_border_color'].';
                padding: '.$skin_data['submenu-links-title_padding_top'].' '.$skin_data['submenu-links-title_padding_right'].' '.$skin_data['submenu-links-title_padding_bottom'].' '.$skin_data['submenu-links-title_padding_left'].';
            }
                .'.$location_info[0].' .suppa_column_title .suppa_item_title {
                    font-size:'.$skin_data['submenu-links-title_link_font_font_size'].'px !important;
                    font-family:'.$skin_data['submenu-links-title_link_font_font_family'].' !important;
                    '.$skin_data['submenu-links-title_link_font_font_family_style'].'
                    color:'.$skin_data['submenu-links-title_link_font_font_color'].';
            ...
            .'.$location_info[0].' .suppa_column_title:hover {
                padding-left : '.( (int)$skin_data['submenu-links-title_padding_left'] + 10 ).'px !important;
                color:'.$skin_data['submenu-links-title_link_color_hover'].';
            }
                .'.$location_info[0].' .suppa_column_title:hover .suppa_item_title {
                    color:'.$skin_data['submenu-links-title_link_color_hover'].';
                }

            /* Column Links */
            .'.$location_info[0].' .suppa_column_link{
                font-size:'.$skin_data['submenu-links-links_font_font_size'].'px !important;
                font-family:'.$skin_data['submenu-links-links_font_font_family'].' !important;
                '.$skin_data['submenu-links-links_font_font_family_style'].'
                color:'.$skin_data['submenu-links-links_font_font_color'].';
                padding-right:'.$skin_data['submenu-links-links_padding_right'].';
                padding-left: '.$skin_data['submenu-links-links_padding_left'].' ;
                padding-top: '.$skin_data['submenu-links-links_padding_top'].' ;
                padding-bottom: '.$skin_data['submenu-links-links_padding_bottom'].' ;
            }
                .'.$location_info[0].' .suppa_column_link .suppa_item_title {
                    font-size:'.$skin_data['submenu-links-links_font_font_size'].'px !important;
                    font-family:'.$skin_data['submenu-links-links_font_font_family'].' !important;
                    '.$skin_data['submenu-links-links_font_font_family_style'].'
                    color:'.$skin_data['submenu-links-links_font_font_color'].';
            ...
            .'.$location_info[0].' .suppa_column_link:nth-child(2) {
                margin-top:'.$skin_data['submenu-links-links_padding_top'].' !important;
            }

            .'.$location_info[0].' .suppa_column_link:hover {
                color:'.$skin_data['submenu-links-links_color_hover'].';
                padding-left : '.( (int)$skin_data['submenu-links-links_padding_left'] + 10 ).'px !important;
            }
                .'.$location_info[0].' .suppa_column_link:hover .suppa_item_title {
                    color:'.$skin_data['submenu-links-links_color_hover'].';
                }
             ...
             ******** Description Style
             ---------------------------------------------------------------- **/
            .'.$location_info[0].' .suppa_submenu_columns_wrap .suppa_item_desc{
                font-size:'.$skin_data['megalinks_desc_font_font_size'].'px !important;
                font-family:'.$skin_data['megalinks_desc_font_font_family'].' !important;
                '.$skin_data['megalinks_desc_font_font_family_style'].'
                color:'.$skin_data['megalinks_desc_font_font_color'].';

                padding-top:'.$skin_data['megalinks_desc_padding_top'].' !important;
            }
            .'.$location_info[0].' .suppa_column_title:hover .suppa_item_desc,
            .'.$location_info[0].' .suppa_column_link:hover .suppa_item_desc {
                color:'.$skin_data['megalinks_desc_color_hover'].';
            }
             ...
             ******** Submenu Mega Links Title Icons Style
             ---------------------------------------------------------------- **/
            /* Title Icon */
            .'.$location_info[0].' .suppa_column_title .ctf_suppa_fa_box {
                color:'.$skin_data['submenu-links-title_link_font_font_color'].';
            }
            .'.$location_info[0].' .suppa_column_title:hover .ctf_suppa_fa_box {
                color:'.$skin_data['submenu-links-title_link_color_hover'].';
            }

            /* Link Icon */
            .'.$location_info[0].' .suppa_column_link .ctf_suppa_fa_box {
                color:'.$skin_data['submenu-links-links_font_font_color'].';
            }
            .'.$location_info[0].' .suppa_column_link:hover .ctf_suppa_fa_box {
                color:'.$skin_data['submenu-links-links_color_hover'].';
            }

            /** F.Awesome Icons **/
            .'.$location_info[0].' .suppa_column_title .suppa_FA_icon {
                font-size:'.$skin_data['submenu_mega_title_fontawesome_icons_size'].' !important;
                margin-top: '.$skin_data['submenu_mega_title_fontawesome_icon_margin_top'].' !important;
                padding-right: '.$skin_data['submenu_mega_title_fontawesome_icon_margin_right'].' !important;
            }

            /** Uploaded Icons **/
            .'.$location_info[0].' .suppa_column_title .suppa_UP_icon {
                width : '.$skin_data['submenu_mega_title_uploaded_icons_width'].' !important;
                height : '.$skin_data['submenu_mega_title_uploaded_icons_height'].' !important;
                margin-top: '.$skin_data['submenu_mega_title_normal_icon_margin_top'].' !important;
                padding-right: '.$skin_data['submenu_mega_title_normal_icon_margin_right'].' !important;
            }
             ...
             ******** Submenu Mega Links Links Icons Style
             ---------------------------------------------------------------- **/
            /** F.Awesome Icons **/
            .'.$location_info[0].' .suppa_column_link .suppa_FA_icon {
                font-size:'.$skin_data['submenu_mega_links_fontawesome_icons_size'].' !important;
                padding-top: '.$skin_data['submenu_mega_links_fontawesome_icon_margin_top'].' !important;
                padding-right: '.$skin_data['submenu_mega_links_fontawesome_icon_margin_right'].' !important;
            }

            /** Uploaded Icons **/
            .'.$location_info[0].' .suppa_column_link .suppa_UP_icon {
                width : '.$skin_data['submenu_mega_links_uploaded_icons_width'].' !important;
                height : '.$skin_data['submenu_mega_links_uploaded_icons_height'].' !important;
                padding-top: '.$skin_data['submenu_mega_links_normal_icon_margin_top'].' !important;
                padding-right: '.$skin_data['submenu_mega_links_normal_icon_margin_right'].' !important;
            }

            /** ----------------------------------------------------------------
             ********  Submenu Mega Links Current Link Style
             ---------------------------------------------------------------- **/
            .'.$location_info[0].' .suppa_menu .suppa_submenu_columns_wrap .current-menu-item,
            .'.$location_info[0].' .suppa_menu .suppa_submenu_columns_wrap .current-menu-item .ctf_suppa_fa_box,
            .'.$location_info[0].' .suppa_menu .suppa_submenu_columns_wrap .current-menu-item .suppa_item_title{
                color:'.$skin_data['submenu_current_link_color'].' !important;
            }
            ...
            .'.$location_info[0].' .suppa_menu .suppa_submenu_columns_wrap .current-menu-item .era_suppa_arrow_box span{
            ...
            .'.$location_info[0].' .suppa_menu_woocommerce_cart > a,
            .'.$location_info[0].' .suppa_menu_woocommerce_cart > a span.suppa_item_title {
                font-size:'.$skin_data['top_level_font_font_size'].'px !important;
                font-family:'.$skin_data['top_level_font_font_family'].' !important;
                '.$skin_data['top_level_font_font_family_style'].'
                color:'.$skin_data['top_level_font_font_color'].';
            ...
            /* boder right or left */
            .'.$location_info[0].' .suppa_menu_woocommerce_cart a.suppa_menu_position_left,
            .'.$location_info[0].' .suppa_menu .suppa_menu_position_left{
                border-right:1px solid '.$skin_data['top-links-border_color'].';
            }
            .'.$location_info[0].' .suppa_menu_woocommerce_cart a.suppa_menu_position_right,
            .'.$location_info[0].' .suppa_menu .suppa_menu_position_right{
                border-left:1px solid '.$skin_data['top-links-border_color'].';
            }
            ...
            .'.$location_info[0].' .suppa_menu_woocommerce_cart:hover > a > span.suppa_item_title{
                color:'.$skin_data['top_level_links_color_hover'].';
            }

            /* Current Link */
            .'.$location_info[0].' .suppa_menu_woocommerce_cart > a.current-menu-item,
            .'.$location_info[0].' .suppa_menu_woocommerce_cart > a.current-menu-ancestor {
                color:'.$skin_data['top-links-current_color'].' ;
                background-color:'.$skin_data['top-links-current_bg'].';
            }
            .'.$location_info[0].' .suppa_menu_woocommerce_cart > a.current-menu-item .ctf_suppa_fa_box,
            .'.$location_info[0].' .suppa_menu_woocommerce_cart > a.current-menu-ancestor .ctf_suppa_fa_box{
                color:'.$skin_data['top-links-current_color'].';
            }

            /* Fix for canvas theme */
            .'.$location_info[0].' .suppa_menu_woocommerce_cart a.cart-contents {
                padding-left:'.$skin_data['top_level_padding_left'].';
                padding-right:'.$skin_data['top_level_padding_left'].';
            }
            .'.$location_info[0].' .suppa_menu_woocommerce_cart a.cart-contents .suppa_item_title{
                font-size:'.$skin_data['top_level_font_font_size'].'px !important;
                font-family:'.$skin_data['top_level_font_font_family'].' !important;
                '.$skin_data['top_level_font_font_family_style'].'
                color:'.$skin_data['top_level_font_font_color'].';
            ...
            /* Hover */
            .'.$location_info[0].' .suppa_menu_woocommerce_cart:hover > a.cart-contents{
                background-color:'.$skin_data['top_level_bg_hover'].';
                color:'.$skin_data['top_level_links_color_hover'].';
            }
            .'.$location_info[0].' .suppa_menu_woocommerce_cart:hover > a.cart-contents span{
                color:'.$skin_data['top_level_links_color_hover'].';
            }
        ...
        suppa_js_settings.scroll_enable         = '".$skin_data['settings-sticky_enable']."';
        suppa_js_settings.scroll_enable_mob     = '".$skin_data['settings-sticky_mobile_enable']."';
