                        ...
                        <div class="admin_suppa_box admin_suppa_box_menu_type" >
                            ...
                            <div class="admin_suppa_box_container">
                                ...
                                <div class="admin_suppa_box_menu_item_types">
                                    ...
                                    <label>
                                        <input type="radio" value="links" class="suppa_menu_type <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" <?php if($menu_type=="links") echo "checked"; ?> /> &nbsp;&nbsp; <?php _e('Use as Mega Links','suppa_menu'); ?><br/>
                                    </label>

                                    <label>
                                        <input type="radio" value="links_style_two" class="suppa_menu_type <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" <?php if($menu_type=="links_style_two") echo "checked"; ?> /> &nbsp;&nbsp; <?php _e('Use as Mega Links {2}','suppa_menu'); ?><br/>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" value="mega_posts" class="suppa_menu_type <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" <?php if($menu_type=="mega_posts") echo "checked"; ?> /> &nbsp;&nbsp; <?php _e('Use as Mega Posts','suppa_menu'); ?><br/>
                                    </label>

                                    <label>
                                        <input type="radio" value="html" class="suppa_menu_type <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" <?php if($menu_type=="html") echo "checked"; ?> /> &nbsp;&nbsp; <?php _e('Use as HTML &amp; Shortcodes','suppa_menu'); ?><br/>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" value="woocommerce_cart" class="suppa_menu_type <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" <?php if($menu_type=="woocommerce_cart") echo "checked"; ?> /> &nbsp;&nbsp; <?php _e('Use as Woocommerce Cart','suppa_menu'); ?><br/>
                                    </label>
                                ...
                                <div <?php if( 'woocommerce_cart' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_woocommerce_cart">
                                </div>

                                <!-- Menu Type : LinksTwo -->
                                <div <?php if( 'links_style_two' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_links_style_two">

                                    <?php
                                        // Container Width
                                        $title  = __( 'Sub-Menu Width' , 'suppa_menu' );
                                        $key    = "menu-item-suppa-linksTwoSubmenuWidth";
                                        $value  = ( empty( $item_meta['_menu-item-suppa-linksTwoSubmenuWidth'][0] ) ) ? '500px' : @$item_meta['_menu-item-suppa-linksTwoSubmenuWidth'][0];

                                    ?>

                                    <span><?php echo $title; ?> </span>
                                    <input type="text" id="edit-<?php echo $key.'-'.$item_id; ?>" class="fr <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" value="<?php echo $value; ?>" />
                                    ...
                                    <?php
                                        ...
                                        $key    = "menu-item-suppa-linksTwoSubmenuAlign";
                                        $value  = @$item_meta['_menu-item-suppa-linksTwoSubmenuAlign'][0];
                                    ...
                                    <?php
                                        // Container Width
                                        $title  = __( 'Main Links Container Width' , 'suppa_menu' );
                                        $key    = "menu-item-suppa-linksTwo_categoriesWidth";
                                        $value  = @$item_meta['_menu-item-suppa-linksTwo_categoriesWidth'][0];
                                ...
                                <div <?php if( 'mega_posts' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_mega_posts">

                                    <?php
                                        // Align
                                        $title  = __( 'How Many Posts You Want To Show ?' , 'suppa_menu' );
                                        $key    = "menu-item-suppa-mega_posts_number";
                                        $value  = @$item_meta['_menu-item-suppa-mega_posts_number'][0];
                                ...
                                <!-- Menu Type : Links -->
                                <div <?php if( 'links' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_links">

                                    <?php
                                        // FullWidth
                                        $title  = __( 'FullWidth' , 'suppa_menu' );
                                        $key    = "menu-item-suppa-links_fullwidth";
                                        $value  = @$item_meta['_menu-item-suppa-links_fullwidth'][0];
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-links_width'][0];
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-links_align'][0];
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-links_column_width'][0];
                                ...
                                <!-- Menu Type : HTML -->
                                <div <?php if( 'html' != $menu_type) echo "style='display:none;'"; ?> class="admin_suppa_box_option_inside suppa_box_type admin_suppa_box_option_inside_html">
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-html_content'][0];
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-html_fullwidth'][0];
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-html_width'][0];
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-html_align'][0];
                            ...
                            <div class="admin_suppa_box_container admin_suppa_box_container_mega_posts">
                                ...
                                <div id="menu-item-suppa-mega_posts" >
                                    ...
                                    <?php
                                        ...
                                        $value  = @$item_meta['_menu-item-suppa-mega_posts_category'][0];
                                    ...
                                    <div>
                                        ...
                                        <?php
                                            ...
                                            echo '<input type="hidden" value="' . $value . '" id="' . $id . '" class="' . $class . ' menu-item-suppa-posts_category" name="' . $name . '" />';
                                            echo $this->suppa_all_categories;
                                        ...
                                        <?php
                                            ...
                                            $value  = @$item_meta['_menu-item-suppa-mega_posts_taxonomy'][0];
