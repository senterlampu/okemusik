   ...
   suppaMenuOB = {
      ...
      layout_and_logo : function ( $menu, config ){
          ...
          if( config.logo_enable == 'no_logo' || config.logo_enable == 'off' || config.logo_enable == '' ){
              ...
              $menu.find('.suppaMenu').prepend( $logo_tag );
          }
              ...
              $menu.find('.suppaMenu').append( $logo_tag );
          }
              ...
              var $sticky_logo = '<a href="'+config.site_url+'" class="suppa_menu_logo logo_left_menu_right sticky_logo" ><img src="' + config.logo_src + '" /></a>';
              $menu.prepend( $logo_tag ).find('.suppaMenu').append( $sticky_logo );
          }
              ...
              var $sticky_logo = '<a href="'+config.site_url+'" class="suppa_menu_logo logo_left_menu_right sticky_logo" ><img src="' + config.logo_src + '" /></a>';
              $menu.prepend( $logo_tag ).find('.suppaMenu').prepend( $sticky_logo );
          }
              ...
              var $sticky_logo = '<a href="'+config.site_url+'" class="suppa_menu_logo logo_right_menu_left sticky_logo " ><img src="' + config.logo_src + '" /></a>';
              $menu.prepend( $logo_tag ).find('.suppaMenu').append( $sticky_logo );
          }
      },
