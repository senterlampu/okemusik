...
class IG_Pb_Product_Plugin {
	...
	public static function init() {
		...
		// Generate menu title
		$menu_title = __( 'PageBuilder', IGPBL );
		...
		// Define admin menus
		$admin_menus = array(
			'page_title' => __( 'PageBuilder', IGPBL ),
			...
			'children'   => array(
				array(
					'page_title' => __( 'PageBuilder - Settings', IGPBL ),
		...
		if ( $plugin['Addons'] ) {
			...
			$admin_menus['children'][] = array(
				'page_title' => __( 'PageBuilder - Add-ons', IGPBL ),
				'menu_title' => $menu_title,
				'capability' => 'manage_options',
	...
	public static function ig_pb_setting_callback_enable_for() {
		...
		?>
		<p class="description">
			<?php _e( 'Uncheck post types where you do not want PageBuilder to be activated.', IGPBL ); ?>
		</p>
		<?php
	}
	...
	public static function ig_pb_setting_callback_cache() {
		...
		<p class="description">
			<?php _e( "Select 'Yes' if you want to cache CSS and JS files of PageBuilder", IGPBL ); ?>
		</p>
	<?php
	}
